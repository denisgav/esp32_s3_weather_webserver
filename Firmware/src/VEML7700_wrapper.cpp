...
String VEML7700_wrapper ::get_sampled_gain_s() const {
    switch (sampled_gain) {
        case VEML7700_GAIN_1: return String("1"); 
        case VEML7700_GAIN_2: return String("2"); 
        case VEML7700_GAIN_1_4: return String("1/4"); 
        case VEML7700_GAIN_1_8: return String("1/8"); 
        default: return String("Unknown(") + String(sampled_gain) + ")";
    }
}
...
String VEML7700_wrapper ::get_sampled_integration_time_s() const {
    switch (sampled_integration_time) {
        case VEML7700_IT_25MS: return String("25"); break;
        case VEML7700_IT_50MS: return String("50"); break;
        case VEML7700_IT_100MS: return String("100"); break;
        case VEML7700_IT_200MS: return String("200"); break;
        case VEML7700_IT_400MS: return String("400"); break;
        case VEML7700_IT_800MS: return String("800"); break;
        default: return String("Unknown(") + String(sampled_integration_time) + ")";
    }
}
